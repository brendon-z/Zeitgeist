...
## Initial roadmap
- [ ] Basic dashboard to display your current watch rotation
- [ ] Ability to add and remove custom-defined watches from your rotation
...
## Additional features
- [ ] Current atomic time display so you can set your watch time easily and accurately
